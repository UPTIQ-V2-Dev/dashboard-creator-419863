...
describe('Dashboard Service', () => {
    ...
    describe('getDashboardData', () => {
        ...
        it('should return complete dashboard data for valid user', async () => {
            ...
            (prisma.quickAction.findMany as any).mockResolvedValue(mockQuickActions);
            (prisma.welcomeVideo.findFirst as any).mockResolvedValue(mockWelcomeVideo);
        ...
        it('should handle user with no dashboard stats', async () => {
            ...
            (prisma.user.findUnique as any).mockResolvedValue(userWithoutStats);
            (prisma.quickAction.findMany as any).mockResolvedValue(mockQuickActions);
            (prisma.welcomeVideo.findFirst as any).mockResolvedValue(mockWelcomeVideo);
        ...
        it('should generate initials from email when name is null', async () => {
            ...
            (prisma.user.findUnique as any).mockResolvedValue(userWithoutName);
            (prisma.quickAction.findMany as any).mockResolvedValue([]);
            (prisma.welcomeVideo.findFirst as any).mockResolvedValue(null);
        ...
        it('should throw ApiError when user not found', async () => {
            ...
            await expect(dashboardService.getDashboardData(999)).rejects.toThrow(
    ...
    describe('getDashboardStats', () => {
        ...
        it('should throw ApiError when user not found', async () => {
            ...
            await expect(dashboardService.getDashboardStats(999)).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'User not found')
            );
        });
    });
    ...
    describe('getRecentItems', () => {
        ...
        it('should return recent items with default limit', async () => {
            ...
            (prisma.recentItem.findMany as any).mockResolvedValue(mockRecentItems);
        ...
        it('should throw ApiError when user not found', async () => {
            ...
            await expect(dashboardService.getRecentItems(999)).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'User not found')
            );
        });
    });
    ...
    describe('getSkillsCount', () => {
        ...
        it('should throw ApiError when user not found', async () => {
            ...
            await expect(dashboardService.getSkillsCount(999)).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'User not found')
            );
        });
    });
    ...
    describe('createOrUpdateDashboardStats', () => {
        ...
        it('should create or update dashboard stats successfully', async () => {
            (prisma.user.findUnique as any).mockResolvedValue({ id: 1 });
            (prisma.dashboardStats.upsert as any).mockResolvedValue(mockStats);
        ...
        it('should throw ApiError when user not found', async () => {
            ...
            await expect(dashboardService.createOrUpdateDashboardStats(999, { skillsCount: 10 })).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'User not found')
            );
        });
    });
    ...
    describe('createRecentItem', () => {
        ...
        it('should create recent item successfully', async () => {
            (prisma.user.findUnique as any).mockResolvedValue({ id: 1 });
            (prisma.recentItem.create as any).mockResolvedValue(mockRecentItem);
        ...
        it('should throw ApiError when user not found', async () => {
            ...
            await expect(dashboardService.createRecentItem(999, { type: 'agent', name: 'Test' })).rejects.toThrow(
                new ApiError(httpStatus.NOT_FOUND, 'User not found')
            );
        });
    });
