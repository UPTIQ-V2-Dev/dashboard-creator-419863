...
router
    ...
    .put(
        ...
        validate(dashboardValidation.createOrUpdateStats),
        dashboardController.createOrUpdateStats
    );
...
router
    ...
    .post(
        auth('manageDashboard'),
        validate(dashboardValidation.createRecentItem),
        dashboardController.createRecentItem
    );
