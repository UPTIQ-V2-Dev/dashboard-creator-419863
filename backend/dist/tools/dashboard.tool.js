...
const getDashboardTool = {
    ...
    description: 'Get complete dashboard data including stats, recent items, user info, quick actions, and welcome video',
...
const updateDashboardStatsTool = {
